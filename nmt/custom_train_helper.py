...
class CustomHelper(tf.contrib.seq2seq.Helper):
...
class TrainingHelper(tf.contrib.seq2seq.Helper):
  ...
  def __init__(self, inputs, sequence_length, time_major=False, name=None):
    ...
    with ops.name_scope(name, "TrainingHelper", [inputs, sequence_length]):
      ...
      self._real_zero_inputs = array_ops.concat([self._zero_inputs,self._zero_inputs,self._zero_inputs], 1)
