  ...
  def __init__(self,
    ...
    **NOTE** If you are using the `BeamSearchDecoder` with a cell wrapped in
    ...
    if isinstance(attention_mechanism, (list, tuple)):
      ...
      if not isinstance(attention_mechanism, AttentionMechanism):
        raise TypeError(
            ...
            % type(attention_mechanism).__name__)
      attention_mechanisms = (attention_mechanism,)
      attention_mechanisms_twice = (attention_mechanism_twice,)
    ...
    if attention_layer_size is not None:
      ...
      self._attention_layers_twice = tuple(
          layers_core.Dense(
              attention_layer_size,
              name="attention_layer_twice",
              use_bias=False,
              dtype=attention_mechanisms_twice[i].dtype)
          for i, attention_layer_size in enumerate(attention_layer_sizes))
    ...
    self._attention_mechanisms_twice = attention_mechanisms_twice
